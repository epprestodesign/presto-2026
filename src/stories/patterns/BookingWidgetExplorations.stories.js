// BROWSE HOTELS / Booking Widget / Explorations — alternate mode-selector
...
export default {
  title: 'Browse Hotels/Booking Widget/Explorations',
...
lives one level up under **Browse Hotels / Booking Widget**.
